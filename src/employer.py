...
class Employer:
    ...
    def __get_vacancies(self) -> None:
        """
        Получает все вакансии работодателя, создавая на их основе
        ...
        while True:
            ...
            for vacancy in vacancies['items']:
                ...
                if vacancy_address is None:
                    vacancy_address = 'Адрес не указан'
                else:
                ...
                # создание объекта класса Vacancy и помещение его в список вакансий работодателя
    ...
    def get_employer_inf(self) -> tuple:
        ...
        вся информация о работодателе
        :return: кортеж с информацией о работодателе
        """
    ...
    def employer_url(self) -> str:
        """
        Возвращает ссылку на страницу работодателя
    ...
    def site_url(self) -> str:
        """
        Возвращает ссылку на сайт работодателя
    ...
    def vacancies_url(self) -> str:
        """
        Возвращает ссылку на список вакансий работодателя
        в формате JSON
