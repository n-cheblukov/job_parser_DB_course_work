...
from src.api_requests import HHAPI
...
def delete_db(database_name: str) -> None:
    """
    Удаляет базу данных по переданному имени
...
def create_db(database_name: str, employers_id_list: list) -> DataBase:
    ...
    заполняя её данными
    :param database_name: имя базы данных
    :param employers_id_list: список id работодателей
...
def menu(database: DataBase) -> None:
    ...
    над данными сохранёнными в бд, с их дальнейшим
    ...
    while True:
        ...
        try:
            user_answer = int(input(
                'Добрый день! Что желаете сделать с полученными данными?\n'
                '0 - Выход\n'
                '1 - Вывести все вакансии с указанием работодателя\n'
                '2 - Вывести количество вакансий у каждого работодателя\n'
